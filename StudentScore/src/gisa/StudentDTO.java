...
public class StudentDTO {
	...
	public StudentDTO(int stdNo, String email, int k, int e, int m, int s, int h ,int t, String mgr, String acc, String loc) {
	...
	}// 오른쪽 마우스 + source + generate toString으로 만들 수 있음
